#ifndef AMPGEN_FLATBACKGROUNDPDF_H
#define AMPGEN_FLATBACKGROUNDPDF_H
...
namespace AmpGen
{
  ...
  */
  ...
  public:
    ...
    #endif
    FlatBackgroundPdf();
    FlatBackgroundPdf( const EventType& type, const AmpGen::MinuitParameterSet& mps, const std::string& prefix = "" );
    virtual ~FlatBackgroundPdf(); 
    ...
    real_t operator()(const Event& evt )             const { return m_weight*evt.flatbkgPdf(); }
