...
namespace AmpGen { 
  ...
  class Event {
    public:
      ...
      real_t* pFlatBkgPdf()                                     { return &m_flatbkgPdf; }
      ...
      real_t flatbkgPdf()                                 const { return m_flatbkgPdf; }
      ...
      void setFlatBkgPdf( const real_t& flatbkgPdf ){ m_flatbkgPdf = flatbkgPdf ; }
